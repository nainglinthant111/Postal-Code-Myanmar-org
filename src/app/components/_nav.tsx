  ...
  return (
    <div className="flex justify-between fixed z-10 items-center border-b-2 p-4 px-4 sm:px-32 w-full bg-white">
      ...
      <div className="flex justify-center items-center">
        <div
          onClick={gotoHome}
          className="cursor-pointer hidden sm:block text-gray-600 text-lg"
        >
          Home
        </div>
        <div
          onClick={gotoState}
          className="cursor-pointer hidden sm:block text-gray-600 text-lg mx-5"
        >
          Demo
        </div>
        <div
          onClick={gotoService}
          className="cursor-pointer hidden sm:block text-gray-600 text-lg mr-5"
        >
          Docs
        </div>
        <div
        ...
        {isAuthenticated ? (
          <div className="hidden sm:block mr-5">
            <div onClick={navigateToProfile} className="cursor-pointer hidden sm:block text-gray-600 text-lg mr-5">
              Profile
            </div>
          </div>
        ) : (
