    ...
    return (
        <div
            ...
            <div className="gap-10 flex font-poppin">
                ...
                <div onClick={gotoState} className="cursor-pointer hidden sm:block text-gray-600 text-lg">
                    Demo
                </div>
                <div onClick={gotoService} className="cursor-pointer hidden sm:block text-gray-600 text-lg">
                    Docs
                </div>
                <div onClick={gotoAbout} className="cursor-pointer hidden sm:block text-gray-600 text-lg">
                    About
                </div>
